---
name: speckit-solid-apply
description: Load and apply the SOLID/TDD/clean-code engineering discipline for the
  current implementation run
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: solid:commands/speckit.solid.apply.md
---
